...
export class TodayController {//implements StateChangeListener {
    // private static _instance: TodayController;
    // private dataElements: TodayController = {
    ...
    // }
    //
    // // public getModel(): TodayDataElements {
